 ...
 */
export declare function PathParams(expression: string, useType: Type<any>): ParameterDecorator;
export declare function PathParams(expression: string): ParameterDecorator;
export declare function PathParams(useType: Type<any>): ParameterDecorator;
export declare function PathParams(options: IParamOptions<any>): ParameterDecorator;
export declare function PathParams(): ParameterDecorator;
/**
 ...
 * @returns {ParameterDecorator}
 */
export declare function RawPathParams(expression: string): ParameterDecorator;
