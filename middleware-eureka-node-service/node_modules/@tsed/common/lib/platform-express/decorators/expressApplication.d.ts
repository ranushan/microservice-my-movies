 ...
 * @type {symbol}
 */
export declare type ExpressApplication = Express.Application;
/**
 ...
 * @decorator
 */
export declare function ExpressApplication(target: Type<any>, targetKey: string, descriptor: TypedPropertyDescriptor<Function> | number): any;
