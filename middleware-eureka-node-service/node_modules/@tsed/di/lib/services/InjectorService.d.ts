...
import { IDILogger, IInjectablePropertyService, IInjectablePropertyValue, IInvokeOptions, ProviderScope, TokenProvider } from "../interfaces";
...
export declare class InjectorService extends Container {
     ...
     * @param options
     */
    bindProperty(instance: any, { propertyKey, useType }: IInjectablePropertyService, locals: Map<TokenProvider, any>, options: Partial<IInvokeOptions>): void;
    /**
     *
     * @param instance
     * @param {string} propertyKey
